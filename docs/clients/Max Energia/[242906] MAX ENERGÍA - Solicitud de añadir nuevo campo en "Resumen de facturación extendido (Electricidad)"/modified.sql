...
SELECT 
    ...
    (select string_agg(hr.name, ', ') from hr_colaborador_giscedata_polissa rel left join hr_colaborador hr on hr.id = rel.colaborador_id where polissa_id = pol.id) as "Colaboradores",
