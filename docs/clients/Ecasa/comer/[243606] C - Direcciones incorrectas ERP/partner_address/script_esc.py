...
cups_obj = c.model('res.partner.address')
...
if True:
#with open("comer_partner_esc.txt", "w") as f:
    #f.write('id;name;orig;new\n')
    for cups_data in tqdm(cups_obj.read(ids, ['es','name'])):
        ...
        #f.write('{};{};{};{}\n'.format(cups_data['id'], cups_data['name'], cups_data['es'], new_es))
